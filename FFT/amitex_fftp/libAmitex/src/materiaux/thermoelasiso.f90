!=======================================================================
!>           FONCTION THERMOELASISO
!!-----------------------------------------------------------------------
!! modele thermoelastique lineaire isotrope 
!!
!!-----------------------------------------------------------------------
!!
...
!! \param[in]  TEMP    temperature en debut de pas
!! \param[in]  DTEMP   increment de temperature
...
!=======================================================================
SUBROUTINE thermoelasiso( STRESS, STATEV, DDSDDE, SSE, SPD, SCD,&
...
!--------------------------------------------------------
  ...
  Tr_Def = Def(1) + Def(2) + Def(3) - 3.0_8 * PROPS(3) * (TEMP + DTEMP - PROPS(4))
  do i = 1,3
     !! De meme on rajoute Coeff(3) * (TEMPF - COEFF(4)) pour les coefficients diagonaux
     STRESS(i) = Lambda0 * Tr_Def + Mu2 * (Def(i) - PROPS(3) * (TEMP + DTEMP - PROPS(4)))
  end do
  do i = 4,6
