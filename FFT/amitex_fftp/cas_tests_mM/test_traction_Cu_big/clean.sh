...
rm bin_amitex/results_restart/*.bin 2>/dev/null
rm bin_amitex/results_restart/*.vtk 2>/dev/null
rm bin_amitex/results_restart/*.log 2>/dev/null
rm bin_amitex/results_restart/*.xml 2>/dev/null
rm bin_amitex/results_restart/*.std 2>/dev/null
rm bin_amitex/results_restart/*.mstd 2>/dev/null
rm bin_amitex/results_restart/*.zstd 2>/dev/null
